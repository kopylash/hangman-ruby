...
Part 1: Hangperson
===========================================================================
With all this machinery in mind, clone this repo into your computer, and let's work on Hangperson.

```sh
$ git clone https://github.com/lgbanuelos/hw-sinatra-saas-hangperson
